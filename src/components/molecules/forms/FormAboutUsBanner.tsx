...
export default function FormAboutUsBanner({ setSelection }: { setSelection: (arg0: string | null) => void }) {
    ...
    const onSubmit = handleSubmit(async (data: any) => {
        ...
        await axios.put(process.env.NEXT_PUBLIC_API_URL + "/update_aboutus_banner", formData, { headers: { Authorization: "Token " + token.value } })
            .then(async (response) => {
